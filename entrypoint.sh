...
curl -sS -X POST \
     ...
     -d '{"commands":[{"command":"recordatorio","description":"Registrar un nuevo recordatorio"},{"command":"recordatorios","description":"Buscar, consultar y editar recordatorios"},{"command":"buscar","description":"Buscar por nombre, descripción o ID"},{"command":"criptoalerta","description":"Crear alerta de precio o inteligente"},{"command":"criptoalertas","description":"Administrar alertas de criptomonedas"},{"command":"criptofuerza","description":"Crear análisis de cambio e impulso"},{"command":"criptofuerzas","description":"Administrar análisis de fuerza"},{"command":"mercados","description":"Lista e informe de mercados"},{"command":"reportar","description":"Reportar un problema"},{"command":"ayuda","description":"Mostrar ayuda"}]}' \
